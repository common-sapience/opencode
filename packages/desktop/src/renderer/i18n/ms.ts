export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Common Sapience telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
