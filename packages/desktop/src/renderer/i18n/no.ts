export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Common Sapience er lastet ned. Vil du installere den og starte på nytt?",
