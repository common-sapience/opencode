export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من Common Sapience. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
