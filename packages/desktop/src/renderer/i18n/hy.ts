export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Common Sapience-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Common Sapience-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
