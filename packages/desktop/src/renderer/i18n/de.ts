export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Common Sapience wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
