export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'Common Sapience. Voleu instal·lar-la i reiniciar l'aplicació?",
