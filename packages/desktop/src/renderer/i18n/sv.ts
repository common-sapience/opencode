export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Common Sapience har laddats ned. Vill du installera den och starta om programmet?",
