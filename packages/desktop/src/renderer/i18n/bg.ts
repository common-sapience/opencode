export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от Common Sapience е изтеглена. Искате ли да я инсталирате и рестартирате?",
