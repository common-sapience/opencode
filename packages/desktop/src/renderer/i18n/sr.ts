export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од Common Sapience је преузета, да ли желите да је инсталирате и поново покренете?",
