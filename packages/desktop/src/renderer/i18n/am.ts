export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የCommon Sapience ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከCommon Sapience ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
