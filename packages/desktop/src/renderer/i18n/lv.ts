export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Common Sapience versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Common Sapience versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
