export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią Common Sapience versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "Common Sapience versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
