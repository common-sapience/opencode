export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Common Sapience has been downloaded, would you like to install it and relaunch?",
