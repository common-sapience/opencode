export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Common Sapience uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Common Sapience'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
