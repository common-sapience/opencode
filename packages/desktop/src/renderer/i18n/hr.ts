export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Common Sapience. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
