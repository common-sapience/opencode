export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Common Sapience foi baixada. Você gostaria de instalá-la e reiniciar?",
