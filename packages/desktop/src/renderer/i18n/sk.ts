export const dict = {
  ...
  "desktop.updater.none.message": "Používate najnovšiu verziu Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzia {{version}} Common Sapience bola stiahnutá. Chcete ju nainštalovať a reštartovať?",
