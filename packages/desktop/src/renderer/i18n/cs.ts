export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Common Sapience. Chcete ji nainstalovat a aplikaci znovu spustit?",
