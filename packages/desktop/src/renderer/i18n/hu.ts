export const dict = {
  ...
  "desktop.updater.none.message": "Már az Common Sapience legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Common Sapience {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
