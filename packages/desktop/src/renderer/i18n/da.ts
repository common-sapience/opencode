export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Common Sapience er blevet downloadet. Vil du installere den og genstarte?",
