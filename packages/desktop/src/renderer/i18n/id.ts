export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Common Sapience versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
