export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Common Sapiencen uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Common Sapiencen versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Common Sapiencen uudelleen?",
