export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Common Sapience è stata scaricata. Vuoi installarla e riavviare l'app?",
