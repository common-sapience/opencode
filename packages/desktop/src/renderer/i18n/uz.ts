export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon Common Sapience ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "Common Sapiencening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
