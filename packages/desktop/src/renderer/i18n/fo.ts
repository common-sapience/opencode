export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Common Sapience.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Common Sapience er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
