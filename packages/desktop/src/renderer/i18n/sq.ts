export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Common Sapience është shkarkuar, dëshironi ta instaloni dhe rinisni?",
