export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Common Sapience a fost descărcată. Vrei să o instalezi și să repornești?",
