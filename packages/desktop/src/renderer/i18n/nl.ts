export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Common Sapience is gedownload. Wil je deze installeren en Common Sapience opnieuw starten?",
