export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Common Sapience. Czy chcesz ją zainstalować i uruchomić ponownie?",
