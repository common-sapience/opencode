export const dict = {
  ...
  "desktop.updater.none.message": "Веќе ја користите најновата верзија на Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзијата {{version}} од Common Sapience е преземена, дали сакате да ја инсталирате и повторно да ја стартувате?",
