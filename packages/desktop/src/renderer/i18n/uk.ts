export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} Common Sapience завантажено. Бажаєте встановити її та перезапустити?",
