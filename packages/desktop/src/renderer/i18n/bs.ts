export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Common Sapience-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Common Sapience-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
