export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Common Sapience a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
