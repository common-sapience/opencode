export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af Common Sapience hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
