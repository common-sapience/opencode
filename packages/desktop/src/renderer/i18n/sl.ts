export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico Common Sapience",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} Common Sapience je bila prenesena, jo želite namestiti in znova zagnati?",
