export const dict = {
  ...
  "desktop.recovery.loadFailed": "Common Sapience kunde inte läsas in",
  "desktop.recovery.terminated": "Common Sapience-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Common Sapience svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Common Sapience misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Common Sapience-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Common Sapience.",
  ...
  "dialog.server.description": "Växla vilken Common Sapience-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Common Sapience i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Common Sapience i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Common Sapience i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Common Sapience i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Common Sapience kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Common Sapience igen.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Common Sapience ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Common Sapience-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Common Sapience stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Common Sapience-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Common Sapience",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Common Sapience ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Common Sapience följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Common Sapiences tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Common Sapience startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Common Sapience.",
