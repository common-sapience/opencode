...
const desktop = [
  ...
  "Lágmarka",
  "Hámarka",
  "Common Sapience skjölun",
  "Aðstoðarspjallborð",
  "Deila ábendingu",
  "Tilkynna villu",
  "Common Sapience-valmynd",
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Common Sapience",
  "Common Sapience-glugganum var óvænt lokað",
  "Common Sapience svarar ekki",
  ...
  "Uppsetning Common Sapience mistókst",
  ...
  "Common Sapience er ekki uppsett í {{distro}}",
  "Uppfærslu Common Sapience lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Common Sapience.",
  ...
  "dialog.server.description": "Skiptu um hvaða Common Sapience miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Common Sapience í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Common Sapience í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Common Sapience í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Common Sapience í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Common Sapience getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Common Sapience aftur.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Common Sapience ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Common Sapience teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Common Sapience styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Common Sapience inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Common Sapience skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Common Sapience netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Common Sapience",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Common Sapience lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Common Sapience fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Common Sapience er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Common Sapience ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Common Sapience.",
