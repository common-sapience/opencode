...
const desktop = [
  ...
  "Minimiziraj",
  "Maksimiziraj",
  "Dokumentacija za Common Sapience",
  "Forum za podršku",
  "Pošalji povratne informacije",
  "Prijavi pogrešku",
  "Izbornik Common Sapience",
  ...
  "Nastavi čekati",
  "Izađi",
  "Common Sapience se nije uspio učitati",
  "Prozor aplikacije Common Sapience neočekivano je zatvoren",
  "Common Sapience ne reagira",
  ...
  "Instalacija aplikacije Common Sapience nije uspjela",
  ...
  "Common Sapience nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Common Sapience je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Common Sapience.",
  ...
  "dialog.server.description": "Promijenite na koji se Common Sapience poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Common Sapience u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Common Sapience u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Common Sapience u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Common Sapience u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Common Sapience",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Common Sapience može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Common Sapience.",
  ...
  "help.tabs.introduction": "Radna površina Common Sapience sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Common Sapience ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Common Sapience timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Common Sapience još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Common Sapience Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Common Sapience poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Common Sapience",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Common Sapience izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Common Sapience slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Common Sapience tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Common Sapience pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Common Sapience.",
