export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Common Sapience",
  ...
  "desktop.recovery.loadFailed": "Common Sapience gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Common Sapience ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Common Sapience tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Common Sapience gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Common Sapience selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Common Sapience.",
  ...
  "dialog.server.description": "Tukar pelayan Common Sapience yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Common Sapience dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Common Sapience dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Common Sapience dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Common Sapience dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Common Sapience boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Common Sapience.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Common Sapience ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Common Sapience",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Common Sapience belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Common Sapience dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Common Sapience",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Common Sapience pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Common Sapience mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Common Sapience.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Common Sapience dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Common Sapience.",
