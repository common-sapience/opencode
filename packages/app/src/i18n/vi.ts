export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Common Sapience",
  ...
  "desktop.recovery.loadFailed": "Không tải được Common Sapience",
  "desktop.recovery.terminated": "Cửa sổ Common Sapience đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Common Sapience không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Common Sapience",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Common Sapience nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Common Sapience cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Common Sapience.",
  ...
  "dialog.server.description": "Chuyển máy chủ Common Sapience mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Common Sapience trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Common Sapience trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Common Sapience trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Common Sapience trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Common Sapience có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Common Sapience.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Common Sapience ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Common Sapience",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Common Sapience chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Common Sapience bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Common Sapience",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Common Sapience trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Common Sapience tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Common Sapience.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Common Sapience khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Common Sapience.",
