export const dict = {
  ...
  "desktop.recovery.loadFailed": "Common Sapience መጫን አልቻለም",
  "desktop.recovery.terminated": "Common Sapience መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Common Sapience ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Common Sapienceመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Common Sapience ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በCommon Sapience",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በCommon Sapience ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "Common Sapience ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በCommon Sapience ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በCommon Sapience ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Common Sapience አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Common Sapienceን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Common Sapience በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Common Sapience በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "Common Sapience ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Common Sapience በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapienceአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Common Sapience WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Common Sapience።",
  ...
  "help.tabs.introduction": "Common Sapience ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የCommon Sapience ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለCommon Sapience ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Common Sapience እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "Common Sapience ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የCommon Sapience አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለCommon Sapience",
  ...
  "settings.general.row.appearance.description": "Common Sapienceበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Common Sapience ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Common Sapience ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Common Sapience ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የCommon Sapience እትም እያሄዱ ነው።",
