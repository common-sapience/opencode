export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Common Sapience",
  ...
  "desktop.menu.ariaLabel": "Menu do Common Sapience",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Common Sapience",
  "desktop.recovery.terminated": "A janela do Common Sapience foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Common Sapience não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Common Sapience",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Common Sapience não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Common Sapience foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Common Sapience.",
  ...
  "dialog.server.description": "Trocar para qual servidor Common Sapience este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Common Sapience em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Common Sapience em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Common Sapience em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "O Common Sapience está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Common Sapience está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Common Sapience em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Common Sapience possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Common Sapience não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Common Sapience novamente.",
  ...
  "help.tabs.introduction": "Agora, o Common Sapience Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Common Sapience ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Common Sapience",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Common Sapience ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Common Sapience dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Common Sapience",
  ...
  "settings.general.row.appearance.description": "Personalize como o Common Sapience aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Common Sapience segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Common Sapience é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Common Sapience iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Common Sapience.",
