export const dict = {
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Common Sapience açyň.",
  ...
  "error.chain.mcpFailed":
    'MCP serweri "{{name}}" şowsuz. Üns beriň, Common Sapience entek MCP tassyklamasyny goldamaýar.',
