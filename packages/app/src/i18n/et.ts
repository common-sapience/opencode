export const dict = {
  ...
  "desktop.recovery.loadFailed": "Common Sapience laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Common Sapience aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Common Sapience ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Common Sapience installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Common Sapience värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Common Sapience'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Common Sapience.",
  ...
  "dialog.server.description": "Lülitage, millise Common Sapience serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Common Sapience kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Common Sapience kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Common Sapience värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Common Sapience värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Common Sapience jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Common Sapience asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Common Sapience saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Common Sapience.",
  ...
  "help.tabs.introduction": "Common Sapience Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Common Sapience ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Common Sapience meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Common Sapience ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Common Sapience Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Common Sapience server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Common Sapience kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Common Sapience teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Common Sapience järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Common Sapience on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Common Sapience käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Common Sapience uusimat versiooni.",
