export const dict = {
  ...
  "wsl.onboarding.windowsRestartRequired":
    "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Common Sapience.",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" ebaõnnestus. Pange tähele, Common Sapience ei toeta veel MCP autentimist.',
  ...
  "settings.general.row.colorScheme.description":
    "Valige, kas Common Sapience järgib süsteemi, heledat või tumedat teemat",
