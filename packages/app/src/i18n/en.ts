...
export const dict = {
  ...
  "command.fileTree.toggle": "Toggle files panel",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" failed. Note, Common Sapience does not support MCP authentication yet.',
  ...
  "settings.general.row.colorScheme.description":
    "Choose whether Common Sapience follows the system, light, or dark theme",
