...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Common Sapience.",
  ...
  "dialog.server.description": "Switch which Common Sapience server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Common Sapience in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Common Sapience in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Common Sapience in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Common Sapience in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Common Sapience can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Common Sapience.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Common Sapience ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Common Sapience team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Common Sapience does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Common Sapience server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Common Sapience",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Common Sapience looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Common Sapience follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Common Sapience is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Common Sapience launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Common Sapience.",
