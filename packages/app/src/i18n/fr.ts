export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Common Sapience",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Common Sapience",
  "desktop.recovery.terminated": "La fenêtre Common Sapience s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Common Sapience ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Common Sapience",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Common Sapience est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Common Sapience.",
  ...
  "dialog.server.description": "Changez le serveur Common Sapience auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Common Sapience dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Common Sapience dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Common Sapience dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Common Sapience dans {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Common Sapience puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Common Sapience.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Common Sapience ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Common Sapience",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Common Sapience ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Common Sapience inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Common Sapience dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Common Sapience",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Common Sapience.",
