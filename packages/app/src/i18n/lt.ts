...
const desktop = [
  ...
  "Suskleisti",
  "Išskleisti",
  "Common Sapience dokumentacija",
  "Pagalbos forumas",
  "Pateikti atsiliepimą",
  "Pranešti apie klaidą",
  "Common Sapience meniu",
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Common Sapience įkelti nepavyko",
  "Common Sapience langas netikėtai užsidarė",
  "Common Sapience neatsako",
  ...
  "Common Sapience įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Common Sapience neįdiegtas distributyve {{distro}}",
  "Common Sapience naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Common Sapience modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Common Sapience.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Common Sapience serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Common Sapience {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Common Sapience {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Common Sapience {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Common Sapience į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Common Sapience galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Common Sapience.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Common Sapience ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Common Sapience komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Common Sapience dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Common Sapience apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Common Sapience darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Common Sapience serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Common Sapience ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Common Sapience atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Common Sapience seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Common Sapience temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Common Sapience",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Common Sapience versiją.",
