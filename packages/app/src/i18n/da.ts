export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Common Sapience.",
  ...
  "dialog.server.description": "Skift hvilken Common Sapience-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Common Sapience i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Common Sapience i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Common Sapience i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Common Sapience kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Common Sapience igen.",
  ...
  "toast.update.description": "En ny version af Common Sapience ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Common Sapience-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Common Sapience understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Common Sapience-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Common Sapience",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Common Sapience ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Common Sapience skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Common Sapiences tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Common Sapience starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Common Sapience.",
  ...
  "desktop.recovery.loadFailed": "Common Sapience kunne ikke indlæses",
  "desktop.recovery.terminated": "Common Sapience-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Common Sapience mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Common Sapience er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Common Sapience Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
