...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Common Sapience yüklenemedi",
  "desktop.recovery.terminated": "Common Sapience penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Common Sapience yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Common Sapience kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Common Sapience güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Common Sapience tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Common Sapience'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Common Sapience'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Common Sapience'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Common Sapience sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Common Sapience kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Common Sapience kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Common Sapience güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Common Sapience güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Common Sapience'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Common Sapience'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Common Sapience hazır.",
  "wsl.onboarding.opencodeReady": "Common Sapience hazır.",
  "wsl.onboarding.installOpencodeIn": "Common Sapience'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Common Sapience'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Common Sapience'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Common Sapience'u tekrar açın.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Common Sapience'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Common Sapience ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Common Sapience henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Common Sapience Masaüstü",
  ...
  "settings.desktop.wsl.description": "Common Sapience sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Common Sapience'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Common Sapience'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Common Sapience'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Common Sapience'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Common Sapience başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Common Sapience'un en son sürümünü kullanıyorsunuz.",
