export const dict = {
  ...
  "settings.general.row.colorScheme.description":
    "Изберете дали Common Sapience ја следи системската, светла или темна тема",
  ...
  "settings.updates.row.startup.description":
    "Автоматски проверувајте дали има ажурирања кога ќе се стартува Common Sapience",
