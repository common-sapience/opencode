...
export const dict = {
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Common Sapience 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Common Sapience 中使用 {{provider}} 模型。",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Common Sapience 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
