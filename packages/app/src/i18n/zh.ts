...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Common Sapience 加载失败",
  "desktop.recovery.terminated": "Common Sapience 窗口意外终止",
  "desktop.recovery.unresponsive": "Common Sapience 未响应",
  ...
  "desktop.wsl.error.installOpencode": "Common Sapience 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 Common Sapience",
  "desktop.wsl.error.updateVersion":
    "Common Sapience 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "command.fileTree.toggle": "切换文件面板",
  ...
  "dialog.model.unpaid.freeModels.title": "Common Sapience 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Common Sapience 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " 获取授权码，以连接你的账户并在 Common Sapience 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的账户并在 Common Sapience 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Common Sapience 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Common Sapience...",
  "wsl.onboarding.updatingOpencode": "正在更新 Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Common Sapience...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Common Sapience。",
  "wsl.onboarding.updateOpencode": "更新 Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Common Sapience 已就绪。",
  "wsl.onboarding.opencodeReady": "Common Sapience 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Common Sapience。",
  "wsl.onboarding.installOpencode": "安装 Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Common Sapience",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Common Sapience 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Common Sapience。",
  ...
  "help.tabs.introduction": "Common Sapience Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Common Sapience 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Common Sapience 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Common Sapience 暂不支持 MCP 认证。',
  ...
  "sidebar.agents.empty": "还没有会话",
  "dialog.agent.create.title": "新建 agent",
  "dialog.agent.create.name": "名字",
  "dialog.agent.create.name.placeholder": "例如：调研助手",
  "dialog.agent.create.description": "这个 agent 负责什么？",
  "dialog.agent.create.description.placeholder": "描述它的工作。这段话就是它的指令。",
  "dialog.agent.create.submit": "创建",
  "dialog.agent.create.creating": "创建中…",
  "sidebar.help": "帮助",
  "sidebar.workspaces.enable": "启用工作区",
  "sidebar.workspaces.disable": "禁用工作区",
  "sidebar.gettingStarted.title": "入门",
  "sidebar.gettingStarted.line1": "Common Sapience 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Common Sapience 服务器。",
  ...
  "settings.general.row.language.description": "更改 Common Sapience 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Common Sapience 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Common Sapience 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Common Sapience 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Common Sapience 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Common Sapience。",
