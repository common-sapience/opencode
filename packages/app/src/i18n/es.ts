export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Common Sapience",
  ...
  "desktop.menu.ariaLabel": "Menú de Common Sapience",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Common Sapience",
  "desktop.recovery.terminated": "La ventana de Common Sapience se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Common Sapience no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Common Sapience",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Common Sapience finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Common Sapience.",
  ...
  "dialog.server.description": "Cambiar el servidor de Common Sapience al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Common Sapience en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Common Sapience en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Common Sapience en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Common Sapience en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Common Sapience pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Common Sapience.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Common Sapience ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Common Sapience",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Common Sapience aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Common Sapience dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Common Sapience",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Common Sapience en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Common Sapience sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Common Sapience.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Common Sapience",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Common Sapience.",
