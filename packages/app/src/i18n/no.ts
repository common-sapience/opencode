...
export const dict = {
  ...
  "desktop.menu.documentation": "Common Sapience-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Common Sapience-meny",
  ...
  "desktop.recovery.loadFailed": "Common Sapience kunne ikke lastes inn",
  "desktop.recovery.terminated": "Common Sapience-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Common Sapience svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Common Sapience mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Common Sapience er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Common Sapience.",
  ...
  "dialog.server.description": "Bytt hvilken Common Sapience-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Common Sapience ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Common Sapience-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Common Sapience ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Common Sapience-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Common Sapience",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Common Sapience ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Common Sapience skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Common Sapience.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Common Sapience starter",
  ...
  "settings.updates.toast.latest.title": "Common Sapience er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Common Sapience.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Common Sapience i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Common Sapience i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Common Sapience i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Common Sapience i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Common Sapience kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Common Sapience på nytt.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
