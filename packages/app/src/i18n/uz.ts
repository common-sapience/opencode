export const dict = {
  ...
  "desktop.menu.documentation": "Common Sapience hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Common Sapience menyusi",
  ...
  "desktop.recovery.loadFailed": "Common Sapience yuklanmadi",
  "desktop.recovery.terminated": "Common Sapience oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Common Sapience javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Common Sapience oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Common Sapience yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Common Sapience tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Common Sapience’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Common Sapience da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Common Sapience da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Common Sapience serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Common Sapience tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Common Sapience {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Common Sapience yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Common Sapience {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Common Sapience-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Common Sapience-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Common Sapience tayyor.",
  "wsl.onboarding.installOpencodeIn": "Common Sapience-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Common Sapience-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Common Sapience WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Common Sapience-ni qayta oching.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Common Sapience ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Common Sapience jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Common Sapience hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Common Sapience bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Common Sapience serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Common Sapience uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Common Sapience qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Common Sapience tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Common Sapience mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Common Sapience ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Common Sapience oxirgi versiyasini ishga tushiryapsiz.",
