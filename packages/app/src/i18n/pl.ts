export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Common Sapience",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Common Sapience",
  "desktop.recovery.terminated": "Okno Common Sapience zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Common Sapience nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Common Sapience",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Common Sapience została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Common Sapience.",
  ...
  "dialog.server.description": "Przełącz serwer Common Sapience, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Common Sapience w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Common Sapience w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Common Sapience w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Common Sapience w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Common Sapience będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Common Sapience.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Common Sapience ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Common Sapience",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Common Sapience nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Common Sapience zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Common Sapience wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Common Sapience",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Common Sapience na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Common Sapience ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Common Sapience.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Common Sapience",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Common Sapience.",
