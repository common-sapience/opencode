export const dict = {
  ...
  "desktop.recovery.loadFailed": "Common Sapience gagal dimuat",
  "desktop.recovery.terminated": "Jendela Common Sapience berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Common Sapience tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Common Sapience gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Common Sapience selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Common Sapience.",
  ...
  "dialog.server.description": "Ganti server Common Sapience mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Common Sapience di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Common Sapience di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Common Sapience di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Common Sapience di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Common Sapience dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Common Sapience.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Common Sapience ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Common Sapience",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Common Sapience belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Common Sapience di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Common Sapience",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Common Sapience di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Common Sapience mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Common Sapience diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Common Sapience.",
