export const dict = {
  ...
  "desktop.recovery.loadFailed": "Common Sapienceを読み込めませんでした",
  "desktop.recovery.terminated": "Common Sapienceのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Common Sapienceが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Common Sapienceのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはCommon Sapienceがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Common Sapienceのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Common Sapienceが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Common Sapienceで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCommon Sapienceで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Common Sapienceで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するCommon Sapienceサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Common Sapienceを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のCommon Sapienceを確認中...",
  "wsl.onboarding.updatingOpencode": "Common Sapienceを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のCommon Sapienceを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のCommon Sapienceを更新してください。",
  "wsl.onboarding.updateOpencode": "Common Sapienceを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のCommon Sapienceの準備ができました。",
  "wsl.onboarding.opencodeReady": "Common Sapienceの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にCommon Sapienceをインストールしてください。",
  "wsl.onboarding.installOpencode": "Common Sapienceをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapienceがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Common SapienceでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Common Sapienceをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Common Sapience Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Common Sapienceの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCommon Sapienceチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: Common SapienceはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Common Sapienceには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCommon Sapienceサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Common Sapienceの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCommon Sapienceの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Common Sapienceがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Common Sapienceのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Common Sapience の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Common Sapience は最新バージョンです。",
