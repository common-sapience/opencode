export const dict = {
  ...
  "toast.update.description":
    "Una nuova versione di Common Sapience ({{version}}) è ora disponibile per l'installazione.",
  ...
  "settings.updates.row.startup.description":
    "Controlla automaticamente gli aggiornamenti all'avvio di Common Sapience",
