export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Common Sapience",
  "desktop.recovery.terminated": "توقفت نافذة Common Sapience بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Common Sapience لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Common Sapience",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Common Sapience، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Common Sapience.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Common Sapience.",
  ...
  "dialog.server.description": "تبديل خادم Common Sapience الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Common Sapience في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Common Sapience في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Common Sapience في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Common Sapience في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Common Sapience من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Common Sapience التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Common Sapience.",
  ...
  "help.tabs.introduction": "أصبح Common Sapience Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Common Sapience ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Common Sapience",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Common Sapience لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Common Sapience نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Common Sapience داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Common Sapience",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Common Sapience على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Common Sapience يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Common Sapience.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Common Sapience",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Common Sapience.",
