export const dict = {
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" nije uspio. Napomena: Common Sapience još ne podržava MCP autentifikaciju.',
  ...
  "settings.general.row.colorScheme.description":
    "Odaberi da li Common Sapience prati sistemsku, svijetlu ili tamnu temu",
