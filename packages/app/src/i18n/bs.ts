export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Common Sapience",
  ...
  "desktop.menu.ariaLabel": "Common Sapience meni",
  ...
  "desktop.recovery.loadFailed": "Common Sapience se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Common Sapience-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Common Sapience ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Common Sapience-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Common Sapience-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Common Sapience-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Common Sapience-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Common Sapience-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Common Sapience server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Common Sapience u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Common Sapience u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Common Sapience u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Common Sapience u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Common Sapience mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Common Sapience.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Common Sapience-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Common Sapience timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Common Sapience još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Common Sapience server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Common Sapience-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Common Sapience izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Common Sapience prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Common Sapience-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Common Sapience pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Common Sapience-a.",
