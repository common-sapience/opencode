...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Common Sapience zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Common Sapience zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Common Sapience zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Common Sapience-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Common Sapience wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Common Sapience in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Common Sapience wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Common Sapience in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Common Sapience in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Common Sapience aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Common Sapience ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Common Sapience in {{distro}}.",
  "wsl.onboarding.installOpencode": "Common Sapience installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Common Sapience einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Common Sapience erneut.",
  ...
  "toast.update.description": "Eine neue Version von Common Sapience ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Common Sapience-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Common Sapience unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Common Sapience mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Common Sapience enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Common Sapience Desktop",
  ...
  "settings.desktop.wsl.description": "Common Sapience-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Common Sapience ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Common Sapience auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Common Sapience dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Common Sapience anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Common Sapience automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Common Sapience ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Common Sapience wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Common Sapience konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Common Sapience-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Common Sapience reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Common Sapience-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Common Sapience-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Common Sapience Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
