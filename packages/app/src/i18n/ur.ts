export const dict = {
  ...
  "error.chain.mcpFailed":
    'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Common Sapience ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "settings.general.row.appearance.description":
    "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Common Sapience کیسا لگتا ہے۔",
