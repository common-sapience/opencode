export const dict = {
  ...
  "error.chain.mcpFailed":
    'Serverul MCP "{{name}}" a eșuat. Atenție, Common Sapience nu suportă încă autentificarea MCP.',
  ...
  "settings.general.row.colorScheme.description":
    "Alege dacă Common Sapience urmează sistemul, tema deschisă sau închisă",
