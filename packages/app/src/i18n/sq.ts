export const dict = {
  ...
  "wsl.onboarding.windowsRestartRequired":
    "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Common Sapience.",
  ...
  "toast.update.description":
    "Një version i ri i Common Sapience ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.chain.mcpFailed":
    'Serveri MCP "{{name}}" dështoi. Shënim, Common Sapience nuk e mbështet ende vërtetimin MCP.',
