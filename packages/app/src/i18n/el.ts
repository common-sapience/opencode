export const dict = {
  ...
  "desktop.menu.documentation": "Common Sapience Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Common Sapience μενού",
  ...
  "desktop.recovery.loadFailed": "Common Sapience απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Common Sapience το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Common Sapience δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Common Sapience η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Common Sapience η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Common Sapience.",
  ...
  "provider.connect.opencodeZen.line1":
    "Common Sapience Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Common Sapience.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Common Sapience.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Common Sapience συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Common Sapience...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Common Sapience σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Common Sapience...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Common Sapience σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Common Sapience σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Common Sapience στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Common Sapience να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Common Sapience.",
  ...
  "help.tabs.introduction": "Common Sapience Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Common Sapience ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Common Sapience",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Common Sapience δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Common Sapience Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Common Sapience μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Common Sapience",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Common Sapience στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Common Sapience ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Common Sapience.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Common Sapience",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Common Sapience.",
