export const dict = {
  ...
  "desktop.recovery.loadFailed": "Common Sapience kan niet worden geladen",
  "desktop.recovery.terminated": "Het Common Sapience-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Common Sapience reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Common Sapience is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapience is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Common Sapience-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Common Sapience",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Common Sapience te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Common Sapience te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Common Sapience te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Common Sapience-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Common Sapience controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Common Sapience controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Common Sapience bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Common Sapience bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Common Sapience bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Common Sapience bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Common Sapience in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapience niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Common Sapience een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Common Sapience opnieuw.",
  ...
  "help.tabs.introduction": "Common Sapience Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Common Sapience ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Common Sapience-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Common Sapience ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Common Sapience bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Common Sapience-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Common Sapience",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Common Sapience eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Common Sapience het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Common Sapience aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Common Sapience wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Common Sapience is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Common Sapience.",
