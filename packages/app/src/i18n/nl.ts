export const dict = {
  ...
  "toast.update.description":
    "Er is nu een nieuwe versie van Common Sapience ({{version}}) beschikbaar om te installeren.",
  ...
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" is mislukt. Let op: Common Sapience ondersteunt nog geen MCP-authenticatie.',
