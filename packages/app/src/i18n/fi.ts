export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Common Sapiencen tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Common Sapiencessa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Common Sapiencessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Common Sapiencessa.",
  ...
  "dialog.server.description": "Vaihda Common Sapience-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Common Sapiencea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Common Sapiencea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Common Sapiencea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Common Sapiencea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Common Sapience jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Common Sapience",
  "wsl.onboarding.opencodeReadyIn": "Common Sapience on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Common Sapience on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Common Sapience jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Common Sapience",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Common Sapiencea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Common Sapience voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Common Sapience ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Common Sapience uudelleen.",
  ...
  "toast.update.description": "Common Sapiencen uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Common Sapience-tiimille",
  ...
  "sidebar.gettingStarted.line1": "Common Sapience sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Common Sapience-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Common Sapiencen näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Common Sapience näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Common Sapience järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Common Sapiencen teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Common Sapience käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Common Sapiencen uusinta versiota.",
  ...
  "desktop.menu.documentation": "Common Sapience-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Common Sapience-valikko",
  ...
  "desktop.recovery.loadFailed": "Common Sapiencen lataaminen epäonnistui",
  "desktop.recovery.terminated": "Common Sapience-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Common Sapience ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Common Sapiencen asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Common Sapiencea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Common Sapiencen päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Common Sapience Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
