export const dict: Record<string, string> = {
  ...
  "error.chain.mcpFailed":
    'MCP සේවාදායකය "{{name}}" අසාර්ථක විය. සටහන, Common Sapience තවමත් MCP සත්‍යාපනයට සහය නොදක්වයි.',
  ...
  "settings.general.row.colorScheme.description":
    "Common Sapience පද්ධතිය, ආලෝකය හෝ අඳුරු තේමාව අනුගමනය කරන්නේද යන්න තෝරන්න",
  ...
  "settings.updates.row.startup.description":
    "Common Sapience දියත් කරන විට යාවත්කාලීන සඳහා ස්වයංක්‍රීයව පරීක්ෂා කරන්න",
