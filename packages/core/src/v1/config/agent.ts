...
const AgentSchema = Schema.StructWithRest(
  Schema.Struct({
    ...
    inherit_base_prompt: Schema.optional(Schema.Boolean).annotate({
      description:
        "Treat the body as a role description added to the built-in base prompt, instead of replacing it.",
    }),
