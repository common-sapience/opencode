...
export const Flag = {
  ...
  // Read at access time so tests and the host can opt back in after module load.
  get OPENCODE_DISABLE_AUTOUPDATE() {
    return optOut("OPENCODE_DISABLE_AUTOUPDATE")
  },
  get OPENCODE_DISABLE_MODELS_FETCH() {
    return optOut("OPENCODE_DISABLE_MODELS_FETCH")
  },
